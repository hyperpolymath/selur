...
bridge (MkRequest cmd payload corr_id) = MkResponse 0 [] corr_id  -- Placeholder

-- Export theorems
export bridgeCorrectness, bridgeSafety, bridgeLiveness, bridgeUniqueness
